...
get the app created:
    ...
    $ heroku apps:create songku
    Creating songku... done, stack is cedar
    http://songku.herokuapp.com/ | git@heroku.com:songku.git
...
You can deploy the skeleton project immediately:
    ...
    [...]
    -----> Launching... done, v3
           http://songku.herokuapp.com deployed to Heroku

    To git@heroku.com:songku.git
     * [new branch]      master -> master

It's live! Hit it with `curl`:

    $ curl http://songku.herokuapp.com
    ["Hello" :from Heroku]
...
Then you can launch the REPL:
    ...
    $ lein repl :connect http://$REPL_USER:$REPL_PASSWORD@songku.herokuapp.com/repl
